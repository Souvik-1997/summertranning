      ...
      <form method="POST" action="{{route('exam.update',$exam->id)}}" >
            ...
            @csrf
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="op1" name="op1" placeholder="Option1" value="{{$exam->op1}}">
                </div>
              </div>
              <div class="form-group row">
                <label for="tqn" class="col-sm-2 col-form-label">Option2:</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="op2" name="op2" placeholder="Option2" value="{{$exam->op2}}">
                </div>
              </div>
              <div class="form-group row">
                <label for="ttime" class="col-sm-2 col-form-label">Option3:</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="op3" name="op3" placeholder="Option3" value="{{$exam->op3}}">
                </div>
              </div>
              <div class="form-group row">
                <label for="stime" class="col-sm-2 col-form-label">Option4:</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="op4" name="op4" placeholder="Option4" value="{{$exam->op4}}">
                </div>
              </div>
              <div class="form-group row">
